...
# AGS runtime contract: bar and popups
...
- Gate runtime recomendado: `bash bootstrap/qa.sh`, solo tras confirmacion
  explicita porque reinicia `ags.service`.
- Incluye:
...
4. Con autorizacion explicita, ejecutar `bash bootstrap/qa.sh`.
